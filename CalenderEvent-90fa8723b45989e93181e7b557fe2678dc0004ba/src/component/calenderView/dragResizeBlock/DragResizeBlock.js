...
export class DragResizeBlock extends Component {
  ...
  constructor(props) {
    ...
    this.connectorsMap[CONNECTOR_BOTTOM_RIGHT] = {
      calculateX: (width) => {
        return width - CONNECTOR_SIZE - 10;
      },
      calculateY: (height) => {
